...
copy Person.BusinessEntity FROM '<Use Your Path>BusinessEntity.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.Person';
copy Person.Person FROM '<Use Your Path>Person.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.StateProvince';
copy Person.StateProvince FROM '<Use Your Path>StateProvince.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.Address';
copy Person.Address FROM '<Use Your Path>Address.csv' DELIMITER E'\t' CSV ENCODING 'latin1';
SELECT 'Copying data into Person.AddressType';
copy Person.AddressType FROM '<Use Your Path>AddressType.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.BusinessEntityAddress';
copy Person.BusinessEntityAddress FROM '<Use Your Path>BusinessEntityAddress.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.ContactType';
copy Person.ContactType FROM '<Use Your Path>ContactType.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.BusinessEntityContact';
copy Person.BusinessEntityContact FROM '<Use Your Path>BusinessEntityContact.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.EmailAddress';
copy Person.EmailAddress FROM '<Use Your Path>EmailAddress.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.Password';
copy Person.Password FROM '<Use Your Path>Password.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.PhoneNumberType';
copy Person.PhoneNumberType FROM '<Use Your Path>PhoneNumberType.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.PersonPhone';
copy Person.PersonPhone FROM '<Use Your Path>PersonPhone.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Person.CountryRegion';
copy Person.CountryRegion FROM '<Use Your Path>CountryRegion.csv' DELIMITER E'\t' CSV;
...
copy HumanResources.Department FROM '<Use Your Path>Department.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into HumanResources.Employee';
copy HumanResources.Employee FROM '<Use Your Path>Employee.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into HumanResources.EmployeeDepartmentHistory';
copy HumanResources.EmployeeDepartmentHistory FROM '<Use Your Path>EmployeeDepartmentHistory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into HumanResources.EmployeePayHistory';
copy HumanResources.EmployeePayHistory FROM '<Use Your Path>EmployeePayHistory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into HumanResources.JobCandidate';
copy HumanResources.JobCandidate FROM '<Use Your Path>JobCandidate.csv' DELIMITER E'\t' CSV ENCODING 'latin1';
SELECT 'Copying data into HumanResources.Shift';
copy HumanResources.Shift FROM '<Use Your Path>Shift.csv' DELIMITER E'\t' CSV;
...
copy Production.BillOfMaterials FROM '<Use Your Path>BillOfMaterials.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.Culture';
copy Production.Culture FROM '<Use Your Path>Culture.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.Document';
copy Production.Document FROM '<Use Your Path>Document.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductCategory';
copy Production.ProductCategory FROM '<Use Your Path>ProductCategory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductSubcategory';
copy Production.ProductSubcategory FROM '<Use Your Path>ProductSubcategory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductModel';
copy Production.ProductModel FROM '<Use Your Path>ProductModel.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.Product';
copy Production.Product FROM '<Use Your Path>Product.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductCostHistory';
copy Production.ProductCostHistory FROM '<Use Your Path>ProductCostHistory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductDescription';
copy Production.ProductDescription FROM '<Use Your Path>ProductDescription.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductDocument';
copy Production.ProductDocument FROM '<Use Your Path>ProductDocument.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.Location';
copy Production.Location FROM '<Use Your Path>Location.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductInventory';
copy Production.ProductInventory FROM '<Use Your Path>ProductInventory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductListPriceHistory';
copy Production.ProductListPriceHistory FROM '<Use Your Path>ProductListPriceHistory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.Illustration';
copy Production.Illustration FROM '<Use Your Path>Illustration.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductModelIllustration';
copy Production.ProductModelIllustration FROM '<Use Your Path>ProductModelIllustration.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductModelProductDescriptionCulture';
copy Production.ProductModelProductDescriptionCulture FROM '<Use Your Path>ProductModelProductDescriptionCulture.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductPhoto';
copy Production.ProductPhoto FROM '<Use Your Path>ProductPhoto.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.ProductProductPhoto';
copy Production.ProductProductPhoto FROM '<Use Your Path>ProductProductPhoto.csv' DELIMITER E'\t' CSV;
...
copy Production.ScrapReason FROM '<Use Your Path>ScrapReason.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.TransactionHistory';
copy Production.TransactionHistory FROM '<Use Your Path>TransactionHistory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.TransactionHistoryArchive';
copy Production.TransactionHistoryArchive FROM '<Use Your Path>TransactionHistoryArchive.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.UnitMeasure';
copy Production.UnitMeasure FROM '<Use Your Path>UnitMeasure.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.WorkOrder';
copy Production.WorkOrder FROM '<Use Your Path>WorkOrder.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Production.WorkOrderRouting';
copy Production.WorkOrderRouting FROM '<Use Your Path>WorkOrderRouting.csv' DELIMITER E'\t' CSV;
...
copy Purchasing.ProductVendor FROM '<Use Your Path>ProductVendor.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Purchasing.PurchaseOrderDetail';
copy Purchasing.PurchaseOrderDetail FROM '<Use Your Path>PurchaseOrderDetail.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Purchasing.PurchaseOrderHeader';
copy Purchasing.PurchaseOrderHeader FROM '<Use Your Path>PurchaseOrderHeader.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Purchasing.ShipMethod';
copy Purchasing.ShipMethod FROM '<Use Your Path>ShipMethod.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Purchasing.Vendor';
copy Purchasing.Vendor FROM '<Use Your Path>Vendor.csv' DELIMITER E'\t' CSV;
...
copy Sales.CountryRegionCurrency FROM '<Use Your Path>CountryRegionCurrency.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.CreditCard';
copy Sales.CreditCard FROM '<Use Your Path>CreditCard.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.Currency';
copy Sales.Currency FROM '<Use Your Path>Currency.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.CurrencyRate';
copy Sales.CurrencyRate FROM '<Use Your Path>CurrencyRate.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.Customer';
copy Sales.Customer FROM '<Use Your Path>Customer.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.PersonCreditCard';
copy Sales.PersonCreditCard FROM '<Use Your Path>PersonCreditCard.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesOrderDetail';
copy Sales.SalesOrderDetail FROM '<Use Your Path>SalesOrderDetail.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesOrderHeader';
copy Sales.SalesOrderHeader FROM '<Use Your Path>SalesOrderHeader.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesOrderHeaderSalesReason';
copy Sales.SalesOrderHeaderSalesReason FROM '<Use Your Path>SalesOrderHeaderSalesReason.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesPerson';
copy Sales.SalesPerson FROM '<Use Your Path>SalesPerson.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesPersonQuotaHistory';
copy Sales.SalesPersonQuotaHistory FROM '<Use Your Path>SalesPersonQuotaHistory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesReason';
copy Sales.SalesReason FROM '<Use Your Path>SalesReason.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesTaxRate';
copy Sales.SalesTaxRate FROM '<Use Your Path>SalesTaxRate.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesTerritory';
copy Sales.SalesTerritory FROM '<Use Your Path>SalesTerritory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SalesTerritoryHistory';
copy Sales.SalesTerritoryHistory FROM '<Use Your Path>SalesTerritoryHistory.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.ShoppingCartItem';
copy Sales.ShoppingCartItem FROM '<Use Your Path>ShoppingCartItem.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SpecialOffer';
copy Sales.SpecialOffer FROM '<Use Your Path>SpecialOffer.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.SpecialOfferProduct';
copy Sales.SpecialOfferProduct FROM '<Use Your Path>SpecialOfferProduct.csv' DELIMITER E'\t' CSV;
SELECT 'Copying data into Sales.Store';
copy Sales.Store FROM '<Use Your Path>Store.csv' DELIMITER E'\t' CSV;
