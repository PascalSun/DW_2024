...
copy Public.DimAccount FROM '<Use Your Path>DimAccount.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimCurrency';
copy Public.DimCurrency FROM '<Use Your Path>DimCurrency.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimCustomer';
copy Public.DimCustomer FROM '<Use Your Path>DimCustomer.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimDate';
copy Public.DimDate FROM '<Use Your Path>DimDate.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimDepartmentGroup';
copy Public.DimDepartmentGroup FROM '<Use Your Path>DimDepartmentGroup.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimEmployee';
copy Public.DimEmployee FROM '<Use Your Path>DimEmployee.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimGeography';
copy Public.DimGeography FROM '<Use Your Path>DimGeography.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimOrganization';
copy Public.DimOrganization FROM '<Use Your Path>DimOrganization.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimProduct';
copy Public.DimProduct FROM '<Use Your Path>DimProduct.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimProductCategory';
copy Public.DimProductCategory FROM '<Use Your Path>DimProductCategory.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimProductSubcategory';
copy Public.DimProductSubcategory FROM '<Use Your Path>DimProductSubcategory.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimPromotion';
copy Public.DimPromotion FROM '<Use Your Path>DimPromotion.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimReseller';
copy Public.DimReseller FROM '<Use Your Path>DimReseller.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimSalesReason';
copy Public.DimSalesReason FROM '<Use Your Path>DimSalesReason.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimSalesTerritory';
copy Public.DimSalesTerritory FROM '<Use Your Path>DimSalesTerritory.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.DimScenario';
copy Public.DimScenario FROM '<Use Your Path>DimScenario.csv' DELIMITER E'|' CSV;
...
copy Public.FactAdditionalInternationalProductDescription FROM '<Use Your Path>FactAdditionalInternationalProductDescription.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactCallCenter';
copy Public.FactCallCenter FROM '<Use Your Path>FactCallCenter.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactCurrencyRate';
copy Public.FactCurrencyRate FROM '<Use Your Path>FactCurrencyRate.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactFinance';
copy Public.FactFinance FROM '<Use Your Path>FactFinance.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactInternetSales';
copy Public.FactInternetSales FROM '<Use Your Path>FactInternetSales.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactInternetSalesReason';
copy Public.FactInternetSalesReason FROM '<Use Your Path>FactInternetSalesReason.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactProductInventory';
copy Public.FactProductInventory FROM '<Use Your Path>FactProductInventory.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactResellerSales';
copy Public.FactResellerSales FROM '<Use Your Path>FactResellerSales.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactSalesQuota';
copy Public.FactSalesQuota FROM '<Use Your Path>FactSalesQuota.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.FactSurveyResponse';
copy Public.FactSurveyResponse FROM '<Use Your Path>FactSurveyResponse.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.NewFactCurrencyRate';
copy Public.NewFactCurrencyRate FROM '<Use Your Path>NewFactCurrencyRate.csv' DELIMITER E'|' CSV;

SELECT 'Copying data into Public.ProspectiveBuyer';
copy Public.ProspectiveBuyer FROM '<Use Your Path>ProspectiveBuyer.csv' DELIMITER E'|' CSV;
